...
import { fetchRejectedApplicationsById} from "../../api/hod_api"; // Import the necessary API functions

const RejectRequestInfo = () => {
  ...
  useEffect(() => {
    const fetchLeaveDetails = async () => {
      try {
        ...
        var response = await fetchRejectedApplicationsById(id); // Assuming you have this function
        if (response?.data) {
  ...
  const handleApprove = async (id) => {
    try {
      ...
      if (response.success) {
        ...
        navigate('/hod_dashboard/rejected-requests'); // Navigate to the rejected requests page
      } else {
...
export default RejectRequestInfo;
